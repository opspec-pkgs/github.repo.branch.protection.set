[![Build Status](https://travis-ci.org/opspec-pkgs/github.repo.branch.protection.set.svg?branch=master)](https://travis-ci.org/opspec-pkgs/github.repo.branch.protection.set)
